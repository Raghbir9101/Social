                      ...
                      <td className="px-4 py-4">
                        <div className="flex flex-col gap-1">
                          <span style={{
                            ...
                            border: `1px solid ${q.location?.source === 'browser_gps' ? 'rgba(16,185,129,0.2)' : q.location?.source === 'ip_lookup' ? 'rgba(59,130,246,0.2)' : 'rgba(156,163,175,0.2)'}`,
                          }}>
                            {q.location?.source === 'browser_gps' ? '📍 GPS' : q.location?.source === 'ip_lookup' ? '🌐 IP' : '❓ N/A'}
                          </span>
                          {q.location?.accuracy != null && q.location.source === 'browser_gps' && (
                            <span className="text-[9px] text-gray-600" title="GPS accuracy in meters">
                              ±{Math.round(q.location.accuracy)}m
                            </span>
                          )}
                        </div>
                      </td>
